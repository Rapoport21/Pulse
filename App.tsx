  ...
  const simControls = useMemo<SimControlAction[]>(() => [
    {
      ...
      icon: <Ambulance size={16} strokeWidth={2} />,
      tone: 'crit',
      action: () => {
        ...
        {toast && (
          ...
          >
            ...
            {toast.type === 'success' ? (
              ...
              <AlertOctagon size={17} color={COLORS.crit} />
            ) : (
              <Activity size={17} color={COLORS.info} />
            )}
            <Mono
          ...
          >
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isCompactNav && <span style={{ fontSize: 16, fontWeight: 500 }}>{item.label}</span>}
                    </NavButton>
                  );
                })}
              </nav>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: isCompactNav ? SPACE.sm : SPACE.md, flexShrink: 0 }}>
              ...
              {debugMode && (
                ...
                >
                  <AlertOctagon size={19} strokeWidth={2} />
                </IconButton>
              )}
            </div>
          </header>
