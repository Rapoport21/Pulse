      ...
      >
        ...
        >
          ...
          >
            ...
            {selectedZone ? (
              ...
              >
                ...
                >
                  <Radio size={22} strokeWidth={1.5} color={COLORS.textMuted} />
          ...
          <TacticalCard padding="md" style={{ display: 'flex', flexDirection: 'column', gap: SPACE.md }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm }}>
                <Thermometer size={12} strokeWidth={2} color={COLORS.textMuted} />
                <Mono tone="muted" size="xs">
      ...
      <PrintPreviewModal
        ...
        content={
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            <h2 style={{ fontSize: 20, fontWeight: 700, borderBottom: '1px solid #ccc', paddingBottom: 8, margin: 0 }}>
    ...
    >
      ...
      <div>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <TrendIcon size={12} strokeWidth={2} color={color} />
            <span
              style={{
                fontFamily: FONTS.mono,
                fontSize: 13,
      ...
      <div>
        <Mono tone="muted" size="xs" style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          <UserCheck size={10} strokeWidth={2} color={COLORS.textMuted} />
          ACTIVE PERSONNEL
        </Mono>
        <div
          style={{
      ...
      {zone.status === Status.CRITICAL && (
        ...
        >
          <AlertTriangle size={16} strokeWidth={2} color={COLORS.crit} style={{ flexShrink: 0, marginTop: 1 }} />
          ...
          <ArrowUpRight size={14} strokeWidth={2} color={COLORS.crit} style={{ flexShrink: 0 }} />
...
const TelemetryStat: React.FC<{
  ...
  >
    <Mono tone="muted" size="xs" style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
      <Icon size={10} strokeWidth={2} color={COLORS.textMuted} />
      {label}
    </Mono>
...
const PatientSearch: React.FC<{
  ...
  return (
    <div style={{ position: 'relative', width: 300 }}>
      ...
      >
        <Search size={13} strokeWidth={2} color={focused ? COLORS.accent : COLORS.textMuted} />
        <input
          type="text"
          value={value}
