...
const ActivationPill: React.FC<{ level: EmsInbound['activationLevel'] }> = ({ level }) => {
  ...
  return (
    ...
    >
      <AlertTriangle size={13} color={color} strokeWidth={2.5} />
      <span
        style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.md }}>
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 4 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm, flexWrap: 'wrap' }}>
              <ModeIcon size={15} strokeWidth={2} color={COLORS.textSecondary} />
              <span
                style={{
                  fontFamily: FONTS.mono,
                  fontSize: 15,
  ...
  if (inbound.length === 0) {
    return (
      ...
      >
        <EmptyState
          compact
          icon={<Radio size={23} strokeWidth={1.8} />}
        ...
        <div style={{ padding: SPACE.base }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm }}>
              <Radio size={17} color={COLORS.accent} strokeWidth={2} />
