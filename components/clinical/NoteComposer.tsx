              ...
              {showAi && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <BrainCircuit size={15} color={COLORS.info} />
  ...
  const renderPreview = () => {
    ...
    return (
      ...
      >
            ...
            {MOCK_COSIGNERS.map((cs) => {
              ...
              return (
                ...
                >
                  ...
                  {active && <CheckCircle2 size={17} color={COLORS.accent} />}
                </motion.button>
              );
            })}
          </div>
        ...
        {/* Sign button */}
        <TacticalButton variant="primary" fullWidth onClick={handleSign} icon={<Lock size={17} />}>
          Sign & Lock Note
        </TacticalButton>
