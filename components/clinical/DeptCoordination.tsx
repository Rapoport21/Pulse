    ...
    return (
      <div style={{ padding: `0 ${SPACE.base}px` }}>
        <button onClick={() => toggleSection('transfers')} style={{
          ...
          {isOpen ? <ChevronUp size={17} color={COLORS.textMuted} /> : <ChevronDown size={17} color={COLORS.textMuted} />}
        </button>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: SPACE.sm }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm }}>
                          <div style={{
                            ...
                            fontFamily: FONTS.mono, fontSize: 11, fontWeight: 600, color: statusCol,
                          }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm, marginBottom: SPACE.xs }}>
                        ...
                        >
                          <ArrowRight size={17} color={statusCol} />
                        </motion.div>
                        <span style={{ fontFamily: FONTS.sans, fontSize: TYPE.body.size, fontWeight: 600, color: COLORS.textPrimary }}>
                          {transfer.to}
                        </span>
                  ...
                  return (
                    <div key={resource.id}>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm }}>
                          <span style={{ fontFamily: FONTS.mono, fontSize: 14, fontWeight: 600, color: barColor }}>
                            {resource.available}
                          </span>
                ...
                {BOTTLENECK_ALERTS.map(alert => {
                  ...
                  return (
                    <div key={alert.id} style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm, marginBottom: SPACE.xs }}>
                        <AlertTriangle size={16} color={alertCol} />
                        <span style={{
