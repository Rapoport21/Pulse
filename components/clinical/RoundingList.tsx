                    ...
                    >
                      ...
                      >
                        ...
                        {v && (
                          ...
                          >
                            <VitalChip icon={<Heart size={13} />} value={`${v.heartRate}`} alert={v.heartRate > 110 || v.heartRate < 50} />
                            <VitalChip icon={<Activity size={13} />} value={`${v.systolic}/${v.diastolic}`} alert={v.systolic < 90} />
                            <VitalChip icon={<Droplets size={13} />} value={`${v.spO2}%`} alert={v.spO2 < 94} />
                          </div>
                        )}
                              ...
                              {flagged.length > 0 && (
                                <div>
                                  <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.xs, marginBottom: SPACE.xs }}>
                                    <FlaskConical size={14} color={COLORS.crit} />
