...
`;
  ...
  const renderVisual = (msg: Message) => {
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: SPACE.md }}>
            ...
            >
              ...
              >
                <Building2 size={14} strokeWidth={2} color={COLORS.info} />
    ...
    if (msg.visualType === 'patientInfo') {
      ...
      return (
        <VisualFrame
          icon={<UserCircle size={15} strokeWidth={2} />}
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <CornerBracket position="tl" color={COLORS.borderStrong} size={13} thickness={1} />
            <CornerBracket position="tr" color={COLORS.borderStrong} size={13} thickness={1} />
            <CornerBracket position="bl" color={COLORS.borderStrong} size={13} thickness={1} />
            <CornerBracket position="br" color={COLORS.borderStrong} size={13} thickness={1} />
