    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <CornerBracket position="tl" color={COLORS.borderStrong} size={13} thickness={1} inset={-1} />
            <CornerBracket position="tr" color={COLORS.borderStrong} size={13} thickness={1} inset={-1} />
            <CornerBracket position="bl" color={COLORS.borderStrong} size={13} thickness={1} inset={-1} />
            <CornerBracket position="br" color={COLORS.borderStrong} size={13} thickness={1} inset={-1} />
