      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.md }}>
            <Activity size={16} strokeWidth={2} color={COLORS.textMuted} />
            <Mono tone="muted" size="xs">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.md }}>
            ...
            {currentCapacity >= 85 ? (
              <TrendingUp size={17} color={COLORS.crit} />
            ) : currentCapacity >= 75 ? (
              <TrendingUp size={17} color={COLORS.warn} />
            ) : (
              <TrendingDown size={17} color={COLORS.ok} />
            )}
            <Mono tone="muted" size="xs">
        ...
        <div style={{ padding: `${SPACE.md}px ${SPACE.lg}px ${SPACE.sm}px` }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm }}>
              ...
              >
                {isPlaying ? <Pause size={17} strokeWidth={2} /> : <Play size={17} strokeWidth={2} style={{ marginLeft: 1 }} />}
              </button>
    ...
    >
      <div style={{ display: 'flex', gap: 0 }}>
        ...
        <div style={{ flex: 1, padding: `${SPACE.md}px ${SPACE.base}px` }}>
          ...
          >
            <Icon size={17} strokeWidth={2} color={meta.color} />
            <span
              style={{
                ...
                <div style={{ paddingTop: SPACE.md }}>
                  ...
                  {event.actor && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm, marginBottom: SPACE.sm }}>
                      <User size={14} strokeWidth={2} color={COLORS.textMuted} />
                      <Mono tone="secondary" size="xs">
                        {event.actor}
                      </Mono>
                      {event.actorRole && (
                  ...
                  {/* Relative time tag */}
                  <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm, marginTop: SPACE.sm }}>
                    <AlertTriangle size={13} strokeWidth={2} color={COLORS.textDim} />
                    <Mono tone="dim" size="xs">
