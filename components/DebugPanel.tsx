  ...
  return (
    ...
    >
      ...
      >
        ...
        {collapsed ? (
          <ChevronUp size={15} strokeWidth={2} color={COLORS.textMuted} />
        ) : (
          <ChevronDown size={15} strokeWidth={2} color={COLORS.textMuted} />
        )}
      </div>
...
export const ConnectionIndicator: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Mono tone="muted" size="xs" style={{ fontSize: 11 }}>
        {status}
      </Mono>
    </div>
  );
