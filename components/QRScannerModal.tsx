      ...
      >
        ...
        <div style={{ display: 'flex', gap: SPACE.sm }}>
          {hasFlash && !error && (
            ...
            >
              {flashOn ? <Zap size={19} /> : <ZapOff size={19} />}
            </button>
          )}
          <button
            type="button"
...
const SnapReticle: React.FC<SnapReticleProps> = ({ lockedBox, color, payload }) => {
  ...
  return (
    ...
    >
      ...
      <CornerBracket position="tl" color={color} size={42} thickness={2.5} inset={-2} />
      <CornerBracket position="tr" color={color} size={42} thickness={2.5} inset={-2} />
      <CornerBracket position="bl" color={color} size={42} thickness={2.5} inset={-2} />
      <CornerBracket position="br" color={color} size={42} thickness={2.5} inset={-2} />
