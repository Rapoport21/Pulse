          ...
          <div style={{ width: '100%' }}>
            ...
            <Section id="PT.TIMELINE" title="Encounter Timeline" icon={Timer}>
              ...
              <Section
                ...
                icon={UserCheck}
                action={
                  <TacticalButton variant="ghost" size="sm" icon={<ArrowRightLeft size={15} />} onClick={() => setShowHandoff(true)}>
                    Handoff
                  </TacticalButton>
                }
              >
              ...
              <div>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <AlertTriangle size={15} strokeWidth={2} color={COLORS.crit} />
                    <BracketLabel tone="muted" size="xs">
                      ALLERGIES
                    </BracketLabel>
                  </div>
                ...
                {(() => {
                  ...
                  if (meds.length === 0) {
                    return (
                      <>
                        <MedRow
                          icon={<CheckCircle2 size={17} color={COLORS.ok} strokeWidth={2} />}
                          title="Ondansetron (Zofran)"
                          sub="4mg IV Push · Given 14:30"
                          status="given"
                        />
                        <MedRow
                          icon={<Syringe size={17} color={COLORS.textSecondary} strokeWidth={2} />}
                      ...
                      <MedRow
                        ...
                        icon={
                          isCompleted
                            ...
                            : isHighAlert
                              ? <AlertTriangle size={17} color={COLORS.warn} strokeWidth={2} />
                              : <Syringe size={17} color={COLORS.textSecondary} strokeWidth={2} />
                        }
                      ...
                      return (
                        ...
                        >
                          ...
                          <div style={{
                            ...
                            {isPending ? '...' : `${lab.value}`}
                            {lab.unit && !isPending && <span style={{ fontSize: 11, color: COLORS.textMuted, marginLeft: 2 }}>{lab.unit}</span>}
                          </div>
            ...
            {(() => {
              ...
              return (
                <Section
                  ...
                  icon={StickyNote}
                  action={
                    <TacticalButton variant="ghost" size="sm" icon={<Plus size={15} />} onClick={() => setShowNoteComposer(true)}>
                      Add Note
                    </TacticalButton>
                  }
                >
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                            {note.signed && <CheckCircle2 size={13} color={COLORS.ok} />}
                            <Mono tone="dim" size="xs">
            ...
            {(() => {
              ...
              return (
                <Section
                  ...
                  icon={ImageIcon}
                  action={
                    <TacticalButton variant="ghost" size="sm" icon={<Plus size={15} />} onClick={() => setShowOrderEntry(true)}>
                      Order
                    </TacticalButton>
                  }
                >
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: SPACE.sm, minWidth: 0 }}>
                        ...
                        <div style={{ minWidth: 0 }}>
                          ...
                          >
                            <Clock size={13} strokeWidth={2} color={COLORS.textDim} />
                            <Mono tone="dim" size="xs">
                              Due {order.time}
                            </Mono>
                          </div>
